static class Appointment {
    ...
    public static bool IsAfternoonAppointment(DateTime appointmentDate) => TimeOnly.FromDateTime(appointmentDate).IsBetween(new TimeOnly(12, 0, 0), new TimeOnly(18, 0, 0));
